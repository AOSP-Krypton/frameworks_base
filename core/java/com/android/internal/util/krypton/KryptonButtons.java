...
public final class KryptonButtons {
    private final String TAG = "KryptonButtons";
    ...
    private static KryptonButtons sInstance;

    public static KryptonButtons getAttachedInstance(Context context) {
        synchronized (sInstanceLock) {
            if (sInstance != null) {
                return sInstance;
            }
            return new KryptonButtons(context);
        }
    }

    public KryptonButtons(Context context) {
        mContext = context;
