...
public class ThreeFingerGestureListener implements PointerEventListener {
    ...
    public ThreeFingerGestureListener(Context context, Callback callback) {
        mCallback = checkNull("callback", callback);
        mSwipeDistance = context.getResources().getInteger(
            com.android.internal.R.integer.config_threeFingerSwipeDistance);
    }
